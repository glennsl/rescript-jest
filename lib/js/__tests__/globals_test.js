...
Jest.testAsync(/* None */0, "testAsync", (function (finish) {
...
Jest.testAsync(/* Some */[1], "testAsync - timeout ok", (function (finish) {
        return Curry._1(finish, Jest.pass);
      }));
...
Jest.testPromise(/* None */0, "testPromise", (function () {
...
Jest.testPromise(/* Some */[1], "testPromise - timeout ok", (function () {
        return Promise.resolve(Jest.pass);
      }));
