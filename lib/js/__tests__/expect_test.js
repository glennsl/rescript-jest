...
describe("Expect", (function () {
        ...
        Jest.test("expectFn", (function () {
                return Jest.Expect[/* toThrowMessage */21]("Invalid_argument,-3,foo", Jest.Expect[/* expectFn */1]((function (prim) {
                                  throw prim;
                                }), [
                                Caml_builtin_exceptions.invalid_argument,
                                "foo"
        ...
        return Jest.test("not not", (function () {
                      return Jest.Expect[/* toThrow */18](Jest.Expect[/* expectFn */1]((function () {
                                        return Jest.Expect[/* toBe */2](/* () */0)(Jest.Expect[/* not_ */23](Jest.Expect[/* not_ */23](Jest.Expect[/* expect */0](/* () */0))));
                                      }), /* () */0));
                    }));
      }));
