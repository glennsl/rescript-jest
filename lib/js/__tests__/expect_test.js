...
describe("Expect", (function () {
        ...
        Jest.test("not toBeCloseTo", (function () {
                return Jest.Expect[/* toBeCloseTo */3](4)(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0](1 + 2)));
              }));
        Jest.test("not toBeSoCloseTo", (function () {
                return Jest.Expect[/* toBeSoCloseTo */4](3.12, 3)(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0](1 + 2.123)));
              }));
        Jest.test("not toBeGreaterThan", (function () {
                return Jest.Expect[/* toBeGreaterThan */5](4)(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0](4)));
              }));
        Jest.test("not toBeGreaterThanOrEqual", (function () {
                return Jest.Expect[/* toBeGreaterThanOrEqual */6](5)(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0](4)));
              }));
        Jest.test("not toBeLessThan", (function () {
                return Jest.Expect[/* toBeLessThan */7](4)(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0](4)));
              }));
        Jest.test("not toBeLessThanOrEqual", (function () {
                return Jest.Expect[/* toBeLessThanOrEqual */8](3)(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0](4)));
              }));
        Jest.test("not toBeSuperSetOf", (function () {
                return Jest.Expect[/* toBeSupersetOf */9](/* array */[
                              "a",
                              "d"
                            ])(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0](/* array */[
                                    "a",
                                    "b",
                                    "c"
                                  ])));
        ...
        Jest.test("not toContain", (function () {
                return Jest.Expect[/* toContain */10]("d")(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0](/* array */[
                                    "a",
                                    "b",
                                    "c"
                                  ])));
        ...
        Jest.test("not toContainString", (function () {
                return Jest.Expect[/* toContainString */11]("nanan")(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0]("banana")));
              }));
        Jest.test("not toHaveLength", (function () {
                return Jest.Expect[/* toHaveLength */13](2)(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0](/* array */[
                                    "a",
                                    "b",
                                    "c"
                                  ])));
        ...
        Jest.test("not toEqual", (function () {
                return Jest.Expect[/* toEqual */12](4)(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0](3)));
              }));
        Jest.test("not toMatch", (function () {
                return Jest.Expect[/* toMatch */14]("nanan")(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0]("banana")));
              }));
        Jest.test("not toMatchRe", (function () {
                return Jest.Expect[/* toMatchRe */15]((/anas/))(Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0]("banana")));
              }));
        Jest.test("not toThrow", (function () {
                return Jest.Expect[/* toThrow */18](Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0]((function () {
                                      return 2;
                                    }))));
              }));
        Jest.test("not toThrowMessage", (function () {
                return Jest.Expect[/* toThrowMessage */20]("Invalid_argument,-3,foo", Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0]((function () {
                                      throw [
                                            Caml_builtin_exceptions.invalid_argument,
                                            "bar"
                                          ];
        ...
        Jest.test("not toThrowMessageRe", (function () {
                return Jest.Expect[/* toThrowMessageRe */21]((/Assert_failure!/), Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0]((function () {
                                      throw [
                                            Caml_builtin_exceptions.assert_failure,
                                            [
                                              "expect_test.ml",
        ...
        return Jest.test("not not", (function () {
                      return Jest.Expect[/* toThrow */18](Jest.Expect[/* expectFn */1]((function () {
                                        return Jest.Expect[/* toBe */2](/* () */0)(Jest.Expect[/* not_ */22](Jest.Expect[/* not_ */22](Jest.Expect[/* expect */0](/* () */0))));
                                      }), /* () */0));
                    }));
      }));
...
describe("ExpectJs", (function () {
        ...
        Jest.test("toBeNull", (function () {
                return Jest.ExpectJs[/* toBeNull */26](Jest.ExpectJs[/* expect */0](null));
              }));
        ...
        Jest.test("not toBeDefined", (function () {
                return Jest.ExpectJs[/* toBeDefined */24](Jest.ExpectJs[/* not_ */22](Jest.ExpectJs[/* expect */0](undefined)));
              }));
        Jest.test("not toBeFalsy", (function () {
                return Jest.ExpectJs[/* toBeFalsy */25](Jest.ExpectJs[/* not_ */22](Jest.ExpectJs[/* expect */0](/* array */[])));
              }));
        Jest.test("not toBeNull", (function () {
                return Jest.ExpectJs[/* toBeNull */26](Jest.ExpectJs[/* not_ */22](Jest.ExpectJs[/* expect */0](4)));
              }));
        Jest.test("not toBeTruthy", (function () {
                return Jest.ExpectJs[/* toBeTruthy */27](Jest.ExpectJs[/* not_ */22](Jest.ExpectJs[/* expect */0](Pervasives.nan)));
              }));
        Jest.test("not toBeUndefined", (function () {
                return Jest.ExpectJs[/* toBeUndefined */28](Jest.ExpectJs[/* not_ */22](Jest.ExpectJs[/* expect */0](4)));
              }));
        Jest.test("not toContainProperties", (function () {
                return Jest.ExpectJs[/* toContainProperties */29](/* array */[
                              "foo",
                              "zoo"
                            ])(Jest.ExpectJs[/* not_ */22](Jest.ExpectJs[/* expect */0]({
                                    foo: 0,
                                    bar: /* true */1
                                  })));
              }));
