  ...
  if (param.tag) {
    ...
    if (typeof match === "number") {
      ...
      switch (match.tag | 0) {
        ...
        case 12 : 
            return expect(match[0]).not.toBeLessThanOrEqual(match[1]);
        case 13 : 
        ...
        case 21 : 
            return expect(match[0]).not.toThrow(String(match[1]));
        case 22 : 
    ...
    if (typeof match$1 === "number") {
      ...
      switch (match$1.tag | 0) {
        ...
        case 21 : 
            return expect(match$1[0]).toThrow(String(match$1[1]));
        case 22 : 
...
function toThrowErrorMatchingSnapshot(param) {
  if (param.tag) {
    return /* Not */Block.__(1, [/* ThrowsMatchSnapshot */Block.__(22, [param[0]])]);
  } else {
    return /* Just */Block.__(0, [/* ThrowsMatchSnapshot */Block.__(22, [param[0]])]);
  }
}

function toThrowException(e, param) {
  if (param.tag) {
    return /* Not */Block.__(1, [/* ThrowsException */Block.__(21, [
                  param[0],
                  e
                ])]);
  } else {
    return /* Just */Block.__(0, [/* ThrowsException */Block.__(21, [
                  param[0],
                  e
                ])]);
  }
...
function toThrowMessage(message, param) {
  if (param.tag) {
    return /* Not */Block.__(1, [/* ThrowsMessage */Block.__(23, [
                  param[0],
                  message
                ])]);
  } else {
    return /* Just */Block.__(0, [/* ThrowsMessage */Block.__(23, [
                  param[0],
                  message
                ])]);
  }
...
function toThrowMessageRe(re, param) {
  if (param.tag) {
    return /* Not */Block.__(1, [/* ThrowsMessageRe */Block.__(24, [
                  param[0],
                  re
                ])]);
  } else {
    return /* Just */Block.__(0, [/* ThrowsMessageRe */Block.__(24, [
                  param[0],
                  re
                ])]);
  }
